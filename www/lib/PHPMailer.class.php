...
class PHPMailer
{
     ...
     * If not empty, will be passed via `-f` to sendmail or as the 'MAIL FROM' value over SMTP.class.
     *
     * @var string
     */
    public $Sender = '';
    ...
    /**
     * The default SMTP.class server port.
     *
     * @var int
     */
    public $Port = 25;
    ...
    /**
     * The SMTP.class HELO of the message.
    ...
    /**
     * What kind of encryption to use on the SMTP.class connection.
     * Options: '', 'ssl' or 'tls'.
     *
     * @var string
     */
    ...
    /**
     * Whether to use SMTP.class authentication.
    ...
    /**
     * Options array passed to stream_context_create when connecting via SMTP.class.
     *
     * @var array
     */
    public $SMTPOptions = [];
    ...
    /**
     * The SMTP.class server timeout in seconds.
    ...
    /**
     * SMTP.class class debug output mode.
     * Debug output level.
     * Options:
     * * `0` No output
     * * `1` Commands
    ...
    /**
     * Whether to keep SMTP.class connection open after each message.
     ...
     * Only supported in `mail` and `sendmail` transports, not in SMTP.class.
     *
     * @var bool
     */
     ...
     * Only applicable when sending via SMTP.class.
     *
    ...
    /**
     * An instance of the SMTP.class sender class.
     *
     * @var class
     */
    protected $smtp;
    ...
    /**
     * SMTP.class RFC standard line ending.
     *
     * @var string
     */
    protected static $LE = "\r\n";
    ...
    {
        //Close any open SMTP.class connection nicely
        $this->smtpClose();
    }
     ...
     * Only generates output if SMTP.class debug output is enabled (@see SMTP::$do_debug).
     *
    ...
    /**
     * Send messages using SMTP.class.
     */
    public function isSMTP()
    {
        $this->Mailer = 'SMTP.class';
    }
    ...
    {
        if ('SMTP.class' == $this->Mailer or
            ('mail' == $this->Mailer and stripos(PHP_OS, 'WIN') === 0)
        ) {
            //SMTP.class mandates RFC-compliant line endings
        ...
        if (ini_get('mail.add_x_header') == 1
            ...
            trigger_error(
                ...
                ' To fix it, switch to sending using SMTP.class, disable the mail.add_x_header option in' .
    ...
    protected function mailSend($header, $body)
    {
        ...
        $params = null;
        //This sets the SMTP.class envelope sender which gets turned into a return-path header by the receiver
    ...
    /**
     * Get an instance to use for SMTP.class operations.
     * Override this function to load your own SMTP.class implementation,
    ...
    /**
     * Provide an instance to use for SMTP.class operations.
     *
     * @param class $smtp
     *
     * @return class
    ...
    /**
     * Send mail via SMTP.class.
     * Returns false if there is a bad MAIL FROM, RCPT, or DATA input.
     *
     * @see PHPMailer::setSMTPInstance() to use a different class.
     *
     * @uses \PHPMailer\PHPMailer\SMTP.class
     *
     * @param string $header The message headers
     * @param string $body   The message body
     *
    ...
    /**
     * Initiate a connection to an SMTP.class server.
    ...
    /**
     * Close the active SMTP.class session if one exists.
     */
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            'authenticate' => 'SMTP.class Error: Could not authenticate.',
            'connect_host' => 'SMTP.class Error: Could not connect to SMTP.class host.',
            'data_not_accepted' => 'SMTP.class Error: data not accepted.',
            ...
            'recipients_failed' => 'SMTP.class Error: The following recipients failed: ',
            'signing' => 'Signing Error: ',
            'smtp_connect_failed' => 'SMTP.class connect() failed.',
            'smtp_error' => 'SMTP.class server error: ',
    ...
    {
        ++$this->error_count;
        if ('SMTP.class' == $this->Mailer and null !== $this->smtp) {
            ...
            if (!empty($lasterror['error'])) {
                ...
                if (!empty($lasterror['smtp_code'])) {
                    $msg .= ' SMTP.class code: ' . $lasterror['smtp_code'];
                }
                if (!empty($lasterror['smtp_code_ex'])) {
                    $msg .= ' Additional SMTP.class info: ' . $lasterror['smtp_code_ex'];
                }
            }
        }
        $this->ErrorInfo = $msg;
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' == $key) {
                //Include a link to troubleshooting docs on SMTP.class connection failure
