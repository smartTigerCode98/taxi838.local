<link rel="stylesheet" href="../../webroot/css/user/client/login.css" media="screen" type="text/css"
...
<div class="login-page">
    <div class="form">
        <form class="register-form" method="post">
            ...
            <input type=submit id="button" name="button" value="увійти">
            <p class="message">Забули пароль? <a href="/user/password_recovery">Відновити</a></p>
        </form>
    </div>
</div>
